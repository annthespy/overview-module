    ...
    results: [
      {
        ...
        skus: {
          1: { quantity: 8, size: "XS" },
          2: { quantity: 16, size: "S" },
          3: { quantity: 17, size: "M" },
          4: { quantity: 10, size: "L" },
          5: { quantity: 15, size: "XL" },
          6: { quantity: 4, size: "XL" },
        },
      },
      {
        style_id: 2,
        ...
        skus: {
          7: { quantity: 16, size: "S" },
          8: { quantity: 8, size: "XS" },
          9: { quantity: 17, size: "M" },
          10: { quantity: 10, size: "L" },
          11: { quantity: 15, size: "XL" },
          12: { quantity: 6, size: "XXL" },
        },
      },
      {
        style_id: 3,
        ...
        skus: {
          13: { quantity: 8, size: "XS" },
          14: { quantity: 16, size: "S" },
          15: { quantity: 17, size: "M" },
          16: { quantity: 10, size: "L" },
          17: { quantity: 15, size: "XL" },
          18: { quantity: 6, size: "XXL" },
        },
      },
      {
        style_id: 4,
        ...
        skus: {
          19: { quantity: 8, size: "XS" },
          20: { quantity: 16, size: "S" },
          21: { quantity: 17, size: "M" },
          22: { quantity: 10, size: "L" },
          23: { quantity: 15, size: "XL" },
          24: { quantity: 6, size: "XXL" },
        },
      },
      {
        style_id: 5,
      ...
      },
      {
        ...
        skus: {
          31: { quantity: 8, size: "XS" },
          32: { quantity: 16, size: "S" },
          33: { quantity: 17, size: "M" },
          34: { quantity: 10, size: "L" },
          35: { quantity: 15, size: "XL" },
          36: { quantity: 6, size: "XXL" },
        },
      },
    ],
  },
